...
def get_history_service(
    ...
    connection_change_repo: Annotated[object, Depends(get_connection_change_repository)]
) -> HistoryService:
    return HistoryService(user_repo, message_repo, connection_repo, conversation_repo, connection_change_repo)
