...
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS stem_cell_therapy_sessions INTEGER DEFAULT 0;

-- Add travel & accommodation columns
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS airport_lounge_access_included BOOLEAN DEFAULT false;
ALTER TABLE packages 
...
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS hotel_nights_included INTEGER DEFAULT 0;
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS hotel_star_rating INTEGER DEFAULT 0;
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS private_translator_included BOOLEAN DEFAULT false;
ALTER TABLE packages 
...
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS laser_sessions INTEGER DEFAULT 0;
ALTER TABLE packages 
...
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS oxygen_therapy_sessions INTEGER DEFAULT 0;
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS post_operation_medication_included BOOLEAN DEFAULT false;
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS prp_sessions_included BOOLEAN DEFAULT false;
ALTER TABLE packages 
    ADD COLUMN IF NOT EXISTS sedation_included BOOLEAN DEFAULT false;
