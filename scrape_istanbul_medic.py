#!/usr/bin/env python3
"""
Istanbul Medic Website Scraper
Scrapes all pages from https://www.istanbulmedic.com/en and saves content to text file
"""
...
class IstanbulMedicScraper:
    def __init__(self, base_url="https://www.istanbulmedic.com/en"):
    ...
    def is_valid_url(self, url):
        ...
        try:
            parsed = urlparse(url)
            return (
                parsed.netloc == 'www.istanbulmedic.com' and
    ...
    def scrape_all_pages(self):
        ...
        print("🚀 Starting Istanbul Medic website scraping...")
